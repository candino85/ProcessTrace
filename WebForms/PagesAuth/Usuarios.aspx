<%@ Page Title="" Language="C#" MasterPageFile="~/PagesAuth/PageAuth.Master" AutoEventWireup="true" CodeBehind="Usuarios.aspx.cs" Inherits="WebForms.PagesAuth.WebForm1" Async="true"  %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="body" runat="server">
    <div class="p-3  bg-secondary">
        ...
        <form runat="server" class="form-control form" >
            <div class="row">
                <div class="col-2">
                ...
                <div class="col-12">
                    <asp:GridView ID="GVUsuarios" runat="server" CssClass="table table-borderless table-hover" AutoGenerateColumns="false">
                        <Columns>
                            ...
                            <asp:BoundField DataField="Perfil.Id" HeaderText="Perfil" />
                            ...
                            <asp:TemplateField HeaderText="Opciones">
                                <ItemTemplate>
                                    <asp:LinkButton runat="server" CommandArgument='<%#Eval("Id") %>' OnClick="Reset_Click" CssClass="btn btn-sm btn-primary">Reset</asp:LinkButton>
